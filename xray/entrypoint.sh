...
required_vars="XRAY_VLESS_PORT XRAY_SS_PORT REALITY_DEST REALITY_SERVER_NAMES REALITY_PRIVATE_KEY REALITY_SHORT_ID SHADOWSOCKS_METHOD SHADOWSOCKS_PASSWORD"
